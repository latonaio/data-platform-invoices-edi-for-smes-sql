...
(
    ...
    `ExchangedDocumentContextProcessingTransactionDateTime`                        varchar(16) DEFAULT NULL,
    `DocumentContextParameterIdentifier`                                           datetime DEFAULT NULL,
    ...
    `DocumentVersionIssueDateOfTransactionProcess`                                 date DEFAULT NULL,
    ...
    `DocumentVersionIssueDateOfBusinessFunction`                                   date DEFAULT NULL,
