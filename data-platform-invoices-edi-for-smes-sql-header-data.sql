CREATE TABLE `data_platform_invoices_edi_for_smes_header_data`
(
    `ExchangedInvoiceDocumentIdentifier`                                           varchar(16) NOT NULL,
    `InvoiceDocument`                                                              varchar(100) DEFAULT NULL,
    `ExchangedDocumentContextSpecifiedTransactionIdentifier`                       varchar(16) DEFAULT NULL,
    `ExchangedDocumentContextProcessingTransactionDateTime`                        datetime DEFAULT NULL,
    `DocumentContextParameterIdentifier`                                           varchar(16) DEFAULT NULL,
    `DocumentContextParameterValueText`                                            varchar(200) DEFAULT NULL,
    `DocumentVersionIdentifier`                                                    varchar(16) DEFAULT NULL,
    `DocumentVersionIssueDate`                                                     date DEFAULT NULL,
    `DocumentContextParameterScenarioIdentifier`                                   varchar(16) DEFAULT NULL,
    `DocumentContextParameterScenarioValueText`                                    varchar(200) DEFAULT NULL,
    ...
    `DocumentVersionIdentificationIdentifier`                                      varchar(16) DEFAULT NULL,
    `DocumentVersionIssueDate`                                                     date DEFAULT NULL,
    `ExchangedInvoiceDocumentName`                                                 varchar(200) DEFAULT NULL,
    `ExchangedInvoiceDocumentTypeCode`                                             varchar(4) DEFAULT NULL,
    `ExchangedInvoiceDocumentIssueDate`                                            date DEFAULT NULL,
    `ExchangedInvoiceDocumentPreviousRevisionIdentifier`                           varchar(16) DEFAULT NULL,
    `ExchangedInvoiceDocumentCategoryCode`                                         varchar(4) DEFAULT NULL,
    `ExchangedInvoiceDocumentSubtypeCode`                                          varchar(4) DEFAULT NULL,
    `NoteInvoiceDocumentSubjectText`                                               varchar(200) DEFAULT NULL,
    `NoteInvoiceDocumentContentText`                                               varchar(200) DEFAULT NULL,
    `ReferencedDocumentIssuerAssignedIdentifier`                                   varchar(16) DEFAULT NULL,
    `NoteInvoiceDocumentIdentifier`                                                varchar(16) DEFAULT NULL,
    ...
    `SupplyChainTradeSettlementInvoiceDocumentCurrencyCode`                        varchar(5) DEFAULT NULL,
    ...
    `InvoiceDocumentSpecifiedPeriodStartDate`                                      date DEFAULT NULL,
    `InvoiceDocumentSpecifiedPeriodEndDate`                                        date DEFAULT NULL,
    `TradePaymentTermsDescriptionText`                                             varchar(200) DEFAULT NULL,
    `TradePaymentTermsDueDate`                                                     date DEFAULT NULL,
    `TradePaymentTermsTypeCode`                                                    varchar(4) DEFAULT NULL,
    `TradeInvoiceDocumentSettlementMonetarySummationChargeTotalAmount`             float(13) DEFAULT NULL,
    `TradeInvoiceDocumentSettlementMonetarySummationAllowanceTotalAmount`          float(13) DEFAULT NULL,
    `TradeInvoiceDocumentSettlementMonetarySummationTaxBasisTotalAmount`           float(13) DEFAULT NULL,
    `TradeInvoiceDocumentSettlementMonetarySummationTaxTotalAmount`                float(13) DEFAULT NULL,
    `TradeInvoiceDocumentSettlementMonetarySummationGrandTotalAmount`              float(13) DEFAULT NULL,
    `TradeInvoiceDocumentSettlementMonetarySummationTotalPrepaidAmount`            float(13) DEFAULT NULL,
    `TradeInvoiceDocumentSettlementMonetarySummationDuePayableAmount`              float(13) DEFAULT NULL,
    `TradeInvoiceDocumentSettlementMonetarySummationNetLineTotalAmount`            float(13) DEFAULT NULL,
    `TradeInvoiceDocumentSettlementMonetarySummationIncludingTaxesLineTotalAmount` float(13) DEFAULT NULL,
    ...
    `DuePayableAmountReferencedDocumentSubtypeCode`                                varchar(4) DEFAULT NULL,

    PRIMARY KEY (`ExchangedInvoiceDocumentIdentifier`)
